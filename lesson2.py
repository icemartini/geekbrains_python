...
my_list = [1, 2.0, None, [], 'text', True, (0, 'str'), {'name': 'John'}]
for i in my_list:
    print(type(i))
...
def change_neighbors(list):
    k = 0
    for j in range(len(list) // 2):
        list[k], list[k+1] = list[k+1], list[k]
        k += 2
    return list
change_neighbors(my_list)
...
rating = [8, 7, 5, 3, 3, 1]
new = input('Enter new integer from zero and above: ')
if new.isdigit():
    new = int(new)
    rating.append(new)
...
# }
goods = []
features = ['name', 'price', 'count', 'units']
for i in range(3):
    good = {}
...
for good in goods:
    for feature, value in good[1].items():
